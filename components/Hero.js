...
const Hero = ({
  ...
  return (
    <div
      className="max-w-screen-xl sm:h-[100vh] h-full mt-24 px-8 xl:px-16 mx-auto flex flex-col justify-around"
      id="about"
    >
      <ScrollAnimationWrapper>
        <motion.div
          className="grid grid-flow-row sm:grid-flow-col grid-rows-2 md:grid-rows-1 sm:grid-cols-2 gap-8 py-6 sm:py-24"
        ...
        >
          <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
            ...
            <ButtonPrimary>Obtine Credit</ButtonPrimary>
          </div>
